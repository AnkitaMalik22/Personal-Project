    ...
    if (students) {
      for (let i = 0; i < students.length; i++) {
        ...
        sendEmail({
          ...
          message: `Hello ${FirstName}!,You have been invited to the Test ${assessment.name} by ${college.FirstName} ${college.LastName} college. Please click on the link to attend the test: https://skillaccess-student.vercel.app/student/login?CollegeId=${CollegeId}&test=${assessmentId}. If you are not registered yet, please register first.`,
        });
      }
    }
